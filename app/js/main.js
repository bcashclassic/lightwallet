...
 
  ...
  App.updateTitle = function(includeNodeType, _isTestNet) {
    ...
    var title = "BCC " + (includeNodeType && settings.lightWallet == 1 ? "Light " : "") + "Wallet " + App.format(appVersion.replace("-testnet", "")) + (_isTestNet ? " - Testnet" : "") + (iriVersion ? " - " + App.format(iriVersion) : "");
